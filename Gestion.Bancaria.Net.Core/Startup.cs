...
namespace Gestion.Bancaria.Net.Core
{
	public class Startup
	{
		...
		{
			services.AddDbContext<EntitiesGestionBancaria>(options => options.UseSqlServer(this.Configuration.GetConnectionString("DefaultConnection")));
